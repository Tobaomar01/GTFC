...
router.post('/exonerations',
  ...
  // projet instruit et saisit ; le MAIRE valide. Remettre une dette publique
  // est un acte de la commune, non de l'exploitant du partenariat. Tant que
  // la validation manque, l'exonération ne réduit aucun montant (FR-020i).
